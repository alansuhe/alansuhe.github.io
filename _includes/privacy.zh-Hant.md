「{{ include.appName }}」（以下統稱「本軟體」）尊重並保護所有使用服務使用者的個人隱私權。為了給您提供更準確、更個人化的服務，本軟體會依照本隱私權政策的規定使用與揭露您的個人資訊。但本軟體將以高度的勤勉、審慎義務對待這些資訊。除本隱私權政策另有規定外，在未徵得您事先許可的情況下，本軟體不會將這些資訊對外揭露或向第三方提供。本軟體會不定時更新本隱私權政策。  
